      ...
      <div className="flex-1 min-h-0 flex overflow-hidden">
        ...
        <main className="flex-1 min-w-0 p-2 flex flex-col gap-2 overflow-hidden">
          <div className="flex-1 min-h-0 flex gap-2 flex-col xl:flex-row">
            ...
            {ui.layoutMode !== 'pro' && <aside className="xl:w-[430px] shrink-0 min-h-0 overflow-hidden"><RightPanel /></aside>}
          </div>
          <BottomDock />
          <div className="shrink-0 h-[160px] min-h-0 overflow-hidden hidden md:block"><BottomInsights /></div>
        </main>
      </div>
      <StatusNewsBar />
    </div>
